...
async def save_officer_location(officer_id):
    ...
    world_name = world_name.replace(r"\",r"\\").replace(r"'",r"\'").replace(r'"',r"\"").replace(r";",r"\;").replace(r"_",r"\_").replace(r"%",r"\%")
    ...
    world_read = world_name.replace(r"\\",r"\").replace(r"\'",r"'").replace(r'\"',r'"').replace(r"\;",r";").replace(r"\_",r"_").replace(r"\%",r"%")
