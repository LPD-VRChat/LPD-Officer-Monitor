...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["category"],
            ["badgecategory.id"],
            name="fk_badges_badgecategory_id_category",
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["event"], ["events.id"], name="fk_calls_events_id_event"
        ),
        sa.ForeignKeyConstraint(
            ["squad"],
            ["savedvoicechannels.id"],
            name="fk_calls_savedvoicechannels_id_squad",
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["officer"], ["officers.id"], name="fk_loaentries_officers_id_officer"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_loaentries_message_id"), "loaentries", ["message_id"], unique=False
    )
    op.create_table(
        "patrols",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["event"], ["events.id"], name="fk_patrols_events_id_event"
        ),
        sa.ForeignKeyConstraint(
            ["main_channel"],
            ["savedvoicechannels.id"],
            name="fk_patrols_savedvoicechannels_id_main_channel",
        ),
        sa.ForeignKeyConstraint(
            ["officer"], ["officers.id"], name="fk_patrols_officers_id_officer"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["submitter"],
            ["officers.id"],
            name="fk_strikeentries_officers_id_submitter",
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_strikeentries_member_id"), "strikeentries", ["member_id"], unique=False
    )
    op.create_table(
        "timerenewals",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["officer"], ["officers.id"], name="fk_timerenewals_officers_id_officer"
        ),
        sa.ForeignKeyConstraint(
            ["renewer"], ["officers.id"], name="fk_timerenewals_officers_id_renewer"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            name="fk_trainings_trainingcategories_id_category",
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["call"],
            ["calls.id"],
            name="fk_calls_officers_calls_call_id",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["officer"],
            ["officers.id"],
            name="fk_calls_officers_officers_officer_id",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["badge_id_owned"],
            ["badges.id"],
            name="fk_officers_badges_owned_badges_badge_id_owned_id",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["officer_id_owned"],
            ["officers.id"],
            name="fk_officers_badges_owned_officers_officer_id_owned_id",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["badge_id_pending"],
            ["badges.id"],
            name="fk_officers_badges_pending_badges_badge_id_pending_id",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["officer_id_pending"],
            ["officers.id"],
            name="fk_officers_badges_pending_officers_officer_id_pending_id",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["officer"],
            ["officers.id"],
            name="fk_officers_trainings_officers_officer_id",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["training"],
            ["trainings.id"],
            name="fk_officers_trainings_trainings_training_id",
            onupdate="CASCADE",
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["channel"],
            ["savedvoicechannels.id"],
            name="fk_patrolvoices_savedvoicechannels_id_channel",
        ),
        sa.ForeignKeyConstraint(
            ["patrol"], ["patrols.id"], name="fk_patrolvoices_patrols_id_patrol"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
        ...
        sa.Column("patrol", sa.Integer(), nullable=True),
        sa.ForeignKeyConstraint(
            ["patrol"], ["patrols.id"], name="fk_vrclocations_patrols_id_patrol"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
